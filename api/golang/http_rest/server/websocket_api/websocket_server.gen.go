...
func (w *ServerInterfaceWrapper) GetStarlarkExecutionsStarlarkExecutionUuidLogs(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "starlark_execution_uuid", ctx.Param("starlark_execution_uuid"), &starlarkExecutionUuid, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
